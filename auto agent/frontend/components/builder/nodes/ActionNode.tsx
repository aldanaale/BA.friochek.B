...
export function ActionNode({ data, selected }: { data: FlowNodeData; selected?: boolean }) {
  return (
    <div
      className={`bg-[rgba(74,222,128,0.05)] border rounded-[3px] px-[15px] py-[13px] min-w-[145px] cursor-pointer shadow-[0_4px_16px_rgba(0,0,0,0.3)] transition-all duration-150 ${
        selected
          ? "border-[#c84b1a] shadow-[0_0_0_1px_rgba(200,75,26,0.3),0_6px_20px_rgba(0,0,0,0.4)]"
          : "border-[rgba(74,222,128,0.3)] hover:border-white/[0.18] hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(0,0,0,0.4)]"
      }`}
    >
      <div className="font-mono text-[8px] font-normal text-[#4ade80] mb-[5px] tracking-[0.3px]">
        {data.tag}
      </div>
