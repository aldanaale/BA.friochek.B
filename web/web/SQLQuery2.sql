...
DROP DATABASE BD_FC
 ...
 -- =============================================================================
-- BD_FC — Plataforma SaaS de Trazabilidad NFC para Refrigeracion
-- Schema completo + Seed Data + Verificacion
-- =============================================================================
...
-- Estados: Pendiente | Instalado | Activo | Inactivo | Dañado | DadoDeBaja
-- ----------------------------------------------------------
...
-- [10] TECNICOS
-- Perfil extendido de usuarios con rol Tecnico (relacion 1:1 con Users).
-- ----------------------------------------------------------
...
-- [11] TRANSPORTISTAS
-- Perfil extendido de usuarios con rol Transportista (relacion 1:1 con Users).
-- ----------------------------------------------------------
...
-- [16] MERMAS
-- Registro de productos perdidos o dañados en transporte o bodega.
-- Nota: ProductName es snapshot historico intencional.
-- ----------------------------------------------------------
...
-- =============================================================================
-- SECCION 2: SEED DATA
-- Todo el seed va en UN solo batch para que las variables persistan.
-- Roles: 0 SuperAdmin | 1 Admin | 2 Cliente | 3 Transportista | 4 Tecnico
-- =============================================================================
...
-- [S3] USERS
-- Roles: 1=Admin | 3=Transportista | 4=Tecnico
-- ----------------------------------------------------------
...
INSERT INTO dbo.Users (Id, TenantId, StoreId, Email, PasswordHash, FullName, Role, IsActive, IsLocked) VALUES
    ...
    (@U3,  @T1, @S1, 'tec1@coca-cola.cl',   'hash_3',  'Diego Tecnico',    4, 1, 0),
    (@U4,  @T2, @S3, 'tec1@pepsi.cl',       'hash_4',  'Felipe Tecnico',   4, 1, 0),
    (@U5,  @T1, @S1, 'trans1@coca-cola.cl', 'hash_5',  'Sebastian Trans',  3, 1, 0),
    (@U6,  @T2, @S3, 'trans1@pepsi.cl',     'hash_6',  'Marcelo Trans',    3, 1, 0),
    (@U7,  @T1, @S2, 'tec2@coca-cola.cl',   'hash_7',  'Andres Tecnico',   4, 1, 0),
    (@U8,  @T2, @S4, 'tec2@pepsi.cl',       'hash_8',  'Camilo Tecnico',   4, 1, 0),
    (@U9,  @T1, @S2, 'trans2@coca-cola.cl', 'hash_9',  'Rodrigo Trans',    3, 1, 0),
    (@U10, @T2, @S4, 'trans2@pepsi.cl',     'hash_10', 'Gonzalo Trans',    3, 1, 0),
    (@U11, @T3, @S5, 'tec1@redbull.cl',     'hash_11', 'Nicolas Tecnico',  4, 1, 0),
    (@U12, @T3, @S6, 'trans1@redbull.cl',   'hash_12', 'Matias Trans',     3, 1, 0),
    (@U13, @T3, @S5, 'tec2@redbull.cl',     'hash_13', 'Cristian Tecnico', 4, 1, 0),
...
PRINT '=== BD_FC CREADA EXITOSAMENTE ==='
PRINT '17 tablas | 14 users | 6 coolers | 6 NFC tags | 6 orders | 6 routes'
...
-- [V1] Conteo de tablas y columnas
-- ----------------------------------------------------------
...
-- [V2] SELECT de cada tabla para inspeccion rapida
-- ----------------------------------------------------------
